...
public class BikeDriverManager : MonoBehaviour
{
	...
	private void Update()
	{
		...
		if (currentState == 1)
		{
			...
			{
				Debug.Log("Plan not found Bike Driver");
			}
		}
	...
	public Dictionary<string, bool> GoalState()
	{
		...
		goalState.Add("hasIngredientsDelivered", (manager.ingredients < 15));
		return goalState;
	}
	...
	private void FindActivities()
	{
		...
		{
			//Debug.Log("Bike Activity name " + activity);
